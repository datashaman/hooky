...
```json
{
  "approved_spec": {
    ...
    "cost_plan": {
      ...
      "max_iterations": 3,
      "model_route": {
        "test": "generate behavior-focused browser or DOM tests"
      }
    },
    "edge_cases": [
      "Whitespace-only new-todo input is rejected.",
      "Whitespace-only edited title destroys the todo.",
      "Malformed localStorage data is handled without persisting editing state.",
      "Visible list updates immediately under active route filters."
    ],
    "non_goals": [
    ...
    "test_plan": [
      "Use behavior-focused tests for TodoMVC UI workflows.",
      "Cover localStorage persistence and route filtering."
    ]
  },
  "generated_at": "2026-06-27T13:34:55+00:00",
  "source": "approved_spec_contract",
  "spec_source": "TodoMVC approved spec to executable tests",
  "tools": {
    "available": [
      "read_file",
      "write_file",
  ...
  "workspace": {
    "artifact_root": ".workflow/eval-runs/test-agent/20260627T131505Z/inclusionai-ling-2-6-1t/tests/generated",
    "project_root": ".workflow/eval-runs/test-agent/20260627T131505Z/inclusionai-ling-2-6-1t",
    "report_root": ".workflow/eval-runs/test-agent/20260627T131505Z/inclusionai-ling-2-6-1t/.workflow/artifacts/test-agent",
    "working_folder": ".workflow/eval-runs/test-agent/20260627T131505Z/inclusionai-ling-2-6-1t"
  }
}
```
